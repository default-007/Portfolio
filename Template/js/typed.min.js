			...
			if (this.stop !== !0) {
				...
				o.timeout = setTimeout(function () {
					...
					if ("^" === r.charAt(0)) {
						var i = 1;
						/^\^\d+/.test(r) &&
							((r = /\d+/.exec(r)[0]), (i += r.length), (e = parseInt(r))),
					...
					o.timeout = setTimeout(function () {
						if (s === t.length) {
							if (
								...
								o.arrayPos === o.strings.length - 1 &&
									(o.options.callback(),
									o.curLoop++,
									o.loop === !1 || o.curLoop === o.loopCount))
							)
								return;
							o.timeout = setTimeout(function () {
								o.backspace(t, s);
							...
							: s <= o.stopNum &&
							  ...
							  o.arrayPos === o.strings.length
									? ((o.arrayPos = 0),
									  ...
									  o.init())
									: o.typewrite(o.strings[o.sequence[o.arrayPos]], s));
				}, e);
			}
		},
